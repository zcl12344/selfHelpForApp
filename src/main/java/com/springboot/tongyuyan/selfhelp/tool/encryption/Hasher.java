package com.springboot.tongyuyan.selfhelp.tool.encryption;
...
public  class Hasher {
    public final Integer DEFAULT_ITERATIONS = 36000;
    ...
    public static void main(String[] args) {
       Hasher a=new Hasher();
       String b=getsalt();
        System.out.println(a.encode("123456",getsalt()));
        System.out.println(a.encode("qwertyuiop"));

        System.out.println( a.checkPassword("qwertyuiop","pbkdf2_sha256$36000$LoEasbRHe5s9$80hTcrti0+2/ZObnf7/fr2AV3dc+G19tbkFSKjWtz+A="));
//        runTests();
    }
